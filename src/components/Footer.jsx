      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '32px', marginBottom: '28px' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '7px', marginBottom: '12px' }}>
            <img src="/logo.svg" alt="SooqGG" style={{ width: '32px', height: '32px', borderRadius: '7px' }} />
            <span style={{ color: '#fff', fontWeight: '800', fontSize: '15px' }}>Sooq<span style={{ color: '#c9a84c' }}>GG</span></span>
          </div>

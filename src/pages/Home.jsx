...
const GAME_COVERS = {
  'PUBG Mobile':         'https://shared.fastly.steamstatic.com/store_item_assets/steam/apps/578080/header.jpg',
  'Free Fire':           'https://play-lh.googleusercontent.com/HIUapBg9JYMIWBbNaFRHNlS0aqAN8l-TM7XQtGl5y7_1PqPVAqzKRZ7dYP8ZjcHHdg=w240-h480',
  'Fortnite':            'https://cdn2.unrealengine.com/social-image-chapter4-s3-3840x2160-d35912cc25ad.jpg',
  'Clash of Clans':      'https://play-lh.googleusercontent.com/LByrur1mTCfaIdCcJCTXdMU0P5-O3HMo5rSGPDl2z5h7dBdZ6xhzUl2q5V77bWL0Yg=w240-h480',
  'Mobile Legends':      'https://play-lh.googleusercontent.com/qd2ooAWo_Liz6MicFxbH4VaCCqJOLJQmJXqRQXHiNFQmGPJhU7EvELxXn9kefW-Rea4=w240-h480',
  'Valorant':            'https://cmsassets.rgpub.io/sanity/images/dsfx7636/news/66bf2fdd14f7fcad41487eca45d6ba3db89fd0b8-1920x1080.jpg',
  'FIFA Mobile':         'https://play-lh.googleusercontent.com/zQwHQZ4rjgUK52JTcU6APLZrFxBNcCzC1l7nLovf6JhS4EJZPUHwUaIEDKhV9rOMp80=w240-h480',
  'Genshin Impact':      'https://play-lh.googleusercontent.com/N-E_5XcmHv47v9c4DMnFWH1g8Y44UFaIgVpkiScGCqFnX8LIaW6vVFbPMlM9USulWA=w240-h480',
  'Call of Duty Mobile': 'https://play-lh.googleusercontent.com/ikP5VGPKkqKBiSHlpfLJF8rCxIHPFsB3CjvzqYZEfhZ8VVlq0W_7QYHSWrIz7y9R_aJ=w240-h480',
  'League of Legends':   'https://cdn.cloudflare.steamstatic.com/steam/apps/2801580/header.jpg',
  'Steam Wallet':        'https://store.steampowered.com/favicon.ico',
...
// Big cinematic background — we'll use a collage of 6 game images
const HERO_GAMES = ['PUBG Mobile','Valorant','Fortnite','Mobile Legends','Free Fire','Genshin Impact']
...
export default function Home() {
  ...
  return (
    <div style={{ background: '#080910', fontFamily: isAr ? "'Cairo', sans-serif" : "'Rajdhani', 'Cairo', sans-serif" }}>
      ...
      {/* ═══════════════════════════════════════════════════════
          HERO — HUGE CINEMATIC BACKGROUND
      ═══════════════════════════════════════════════════════ */}
      <div style={{ position: 'relative', minHeight: '600px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '100px 24px 80px', textAlign: 'center', overflow: 'hidden' }}>

        {/* BACKGROUND: 6-panel game collage */}
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(6, 1fr)', height: '100%' }}>
            {HERO_GAMES.map((name, i) => (
              <div key={name} style={{
                backgroundImage: `url(${GAME_COVERS[name]})`,
          ...
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to bottom, rgba(8,9,16,0.55) 0%, rgba(8,9,16,0.3) 30%, rgba(8,9,16,0.75) 75%, rgba(8,9,16,1) 100%)' }} />
          <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to right, rgba(8,9,16,0.6) 0%, transparent 20%, transparent 80%, rgba(8,9,16,0.6) 100%)' }} />
          {/* Purple glow from top center */}
          <div style={{ position: 'absolute', top: '-100px', left: '50%', transform: 'translateX(-50%)', width: '800px', height: '500px', background: 'radial-gradient(ellipse, rgba(124,58,237,0.3) 0%, transparent 65%)', pointerEvents: 'none' }} />
        </div>
        ...
        <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '900px' }}>
          ...
          {/* Live badge */}
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(124,58,237,0.2)', border: '1px solid rgba(124,58,237,0.5)', borderRadius: '100px', padding: '6px 20px', fontSize: '13px', color: '#c4b5fd', marginBottom: '28px', fontWeight: '600' }}>
          ...
          {/* Main headline */}
          <h1 style={{ fontSize: 'clamp(44px, 8vw, 88px)', fontWeight: '700', color: '#fff', lineHeight: '1.0', margin: '0 auto 22px', letterSpacing: isAr ? '0' : '-1px', fontFamily: isAr ? "'Cairo', sans-serif" : "'Rajdhani', sans-serif", textShadow: '0 4px 30px rgba(0,0,0,0.5)' }}>
            {isAr ? (
              <>اشتري وبع{' '}
          ...
          <p style={{ color: '#94a3b8', fontSize: '18px', maxWidth: '560px', margin: '0 auto 44px', lineHeight: '1.7' }}>
            {isAr
          ...
          <div style={{ maxWidth: '620px', margin: '0 auto 20px' }}>
            <div style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.18)', borderRadius: '18px', display: 'flex', alignItems: 'center', padding: '7px 7px 7px 22px', backdropFilter: 'blur(20px)', boxShadow: '0 8px 32px rgba(0,0,0,0.3)' }}>
              ...
              <input
                ...
                style={{ flex: 1, background: 'transparent', border: 'none', outline: 'none', color: '#fff', fontSize: '16px', padding: '9px 0', fontFamily: 'inherit' }}
              />
              <button onClick={() => navigate(`/listings/topups?q=${search}`)}
                style={{ background: 'linear-gradient(135deg, #7c3aed, #6d28d9)', border: 'none', borderRadius: '13px', color: '#fff', padding: '14px 30px', fontSize: '16px', fontWeight: '700', cursor: 'pointer', fontFamily: 'inherit', whiteSpace: 'nowrap', boxShadow: '0 4px 16px rgba(124,58,237,0.5)', flexShrink: 0 }}>
                {isAr ? 'بحث' : 'Search'}
              </button>
            </div>
            {/* Quick links */}
            <div style={{ display: 'flex', gap: '8px', marginTop: '14px', justifyContent: 'center', flexWrap: 'wrap' }}>
              {['PUBG Mobile', 'Free Fire', 'Valorant', 'Mobile Legends', 'Fortnite'].map(g => (
                <button key={g} onClick={() => navigate(`/listings/topups?q=${g}`)}
                  style={{ background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.14)', borderRadius: '100px', padding: '5px 16px', fontSize: '13px', color: '#94a3b8', cursor: 'pointer', fontFamily: 'inherit', backdropFilter: 'blur(10px)', transition: 'all 0.2s' }}
          ...
          {/* Stats */}
          <div style={{ display: 'flex', justifyContent: 'center', gap: '0', flexWrap: 'wrap', maxWidth: '600px', margin: '32px auto 0', background: 'rgba(0,0,0,0.3)', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.08)', backdropFilter: 'blur(10px)', overflow: 'hidden' }}>
            {[
              ...
              <div key={s.label} style={{ flex: '1', minWidth: '100px', padding: '18px 8px', borderLeft: i > 0 ? '1px solid rgba(255,255,255,0.07)' : 'none', textAlign: 'center' }}>
                <div style={{ fontSize: '26px', fontWeight: '700', color: '#fff', fontFamily: isAr ? "'Cairo'" : "'Rajdhani'", lineHeight: '1' }}>{s.value}</div>
      ...
      {/* ── TRUST BAR ── */}
      <div style={{ background: 'rgba(255,255,255,0.025)', borderTop: '1px solid rgba(255,255,255,0.06)', borderBottom: '1px solid rgba(255,255,255,0.06)', padding: '14px 24px', display: 'flex', justifyContent: 'center', gap: '40px', flexWrap: 'wrap' }}>
        {[
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '44px 20px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', marginBottom: '40px', overflowX: 'auto', paddingBottom: '4px' }}>
          {cats.map(c => (
            <button key={c.id} onClick={() => setActiveCat(c.id)} style={{
              ...
              padding: '11px 22px', borderRadius: '12px', fontSize: '15px', fontWeight: '700',
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '22px' }}>
          <h2 style={{ fontSize: '28px', fontWeight: '700', color: '#fff', fontFamily: isAr ? "'Cairo'" : "'Rajdhani'", letterSpacing: isAr ? '0' : '0.5px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(170px, 1fr))', gap: '14px', marginBottom: '56px' }}>
          {filteredGames.map(game => (
            <Link key={game.id} to={`/listings/topups?game=${game.id}`} style={{
              ...
              border: '1px solid rgba(255,255,255,0.07)', background: '#0d0e18',
              transition: 'all 0.25s', textDecoration: 'none', position: 'relative',
            }}
              onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-6px)'; e.currentTarget.style.borderColor = game.color + '90'; e.currentTarget.style.boxShadow = `0 20px 40px rgba(0,0,0,0.5), 0 0 0 1px ${game.color}50` }}
            ...
            >
              {/* Game image */}
              <div style={{ height: '120px', position: 'relative', overflow: 'hidden', background: `linear-gradient(135deg, ${game.color}44, #0d0e18)` }}>
                <img
                ...
                />
                <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(13,14,24,1) 0%, rgba(13,14,24,0.1) 50%, rgba(13,14,24,0) 100%)' }} />
                {game.hot && (
                  <div style={{ position: 'absolute', top: '8px', left: '8px', background: 'linear-gradient(135deg, #ef4444, #dc2626)', borderRadius: '6px', fontSize: '9px', color: '#fff', padding: '2px 8px', fontWeight: '800', letterSpacing: '1px', boxShadow: '0 2px 8px rgba(239,68,68,0.5)' }}>HOT</div>
                )}
              </div>

              <div style={{ padding: '10px 14px 14px' }}>
                <div style={{ fontSize: '14px', fontWeight: '700', color: '#fff', marginBottom: '6px', fontFamily: isAr ? "'Cairo'" : "'Rajdhani'" }}>
        ...
        {/* ── BEST DEALS ── */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '22px' }}>
          <h2 style={{ fontSize: '28px', fontWeight: '700', color: '#fff', fontFamily: isAr ? "'Cairo'" : "'Rajdhani'" }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '56px' }}>
          {LISTINGS.map(l => {
            ...
            return (
              <div key={l.id}
                style={{ background: '#0d0e18', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '16px', padding: '18px 22px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap', cursor: 'pointer', transition: 'all 0.2s' }}
                ...
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)'; e.currentTarget.style.background = '#0d0e18'; e.currentTarget.style.transform = 'translateX(0)' }}
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '14px', flex: 1, minWidth: '180px' }}>
                  <div style={{ width: '56px', height: '56px', borderRadius: '14px', overflow: 'hidden', border: `1px solid ${game?.color || '#7c3aed'}50`, flexShrink: 0, background: `${game?.color || '#7c3aed'}22` }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                  ...
                  <button
                    ...
                    onMouseEnter={e => { e.currentTarget.style.transform = 'scale(1.05)'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(124,58,237,0.55)' }}
        ...
        {/* ── HOW IT WORKS ── */}
        <div style={{ background: '#0d0e18', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '24px', padding: '52px 40px', marginBottom: '32px', textAlign: 'center' }}>
          <h2 style={{ fontSize: '34px', fontWeight: '700', color: '#fff', marginBottom: '10px', fontFamily: isAr ? "'Cairo'" : "'Rajdhani'" }}>
